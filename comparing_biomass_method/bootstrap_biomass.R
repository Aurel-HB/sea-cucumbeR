...
surfCompte <- data_abun$area/1e+6 #convert m² in km²
...
## RESULT ABUNDANCE --------------------------------------
## abundance in number of individuals relative to the total area of each square
dat$Abun_square <- dat$intensity*surfsquare

## RESULT BIOMASSE --------------------------------------
## biomass in tonnes relative to the total area of each square
...
TAC <- as.numeric((1.5/100)*quantile_5)
